...
import { ActionButtonsRow, ActionButtonsRowConfirmed, ActionButtonsRowFinalize } from "@/src/components/action-button"
...
export function BookingCard({
    ...
    return (
        <div className="flex flex-col w-full gap-1.5">
            ...
            {/* Карточка активности */}
            <div className={`flex items-start gap-4 p-1 rounded-sm border bg-white hover:bg-violet-50 w-full h-[88px] ${
                ...
                <div className="flex-1 ml-4 pt-0.5 min-w-0"> {/* ml-4 = 18px отступ */}
                    ...
                    <div className="text-sm font-medium leading-tight line-clamp-1 h-4 mb-1">
                        {service.name}
                    </div>

                    {/* Клиент и описание (2 строки) */}
                    <div className="flex items-start h-8 mb-1">
