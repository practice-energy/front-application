...
import { ExceptionalSlotsSection } from "@/src/components/adept-calendar/settings-sections/exceptional-slots-section"
import { PeriodsFormatsSection } from "@/src/components/adept-calendar/settings-sections/periods-formats-section"
import type { CalendarRestrictions } from "@/src/types/calendar-event"
import { useIsMobile } from "@/src/hooks/use-mobile"
import {useState} from "react";
import {SettingsSectionHeader} from "@/src/components/adept-calendar/settings-sections/settings-section-header";
import {SettingsSectionContent} from "@/src/components/adept-calendar/settings-sections/settings-section-content";
import {TimezoneSection} from "@/src/components/adept-calendar/settings-sections/timezone-section";
