...
import { Copy, Check, Twitter, Facebook, Linkedin, MessageCircle, Mail, Link, Share2 } from "lucide-react"
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <DialogHeader>
                    <DialogTitle className="text-gray-900 dark:text-gray-100">Share Specialist</DialogTitle>
                </DialogHeader>
