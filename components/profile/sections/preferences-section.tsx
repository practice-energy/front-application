          ...
          <CardContent className="p-6 pt-0 space-y-4">
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Get instant notifications on your device</p>
              </div>
              <Switch
                    ...
                    return (
                        ...
                        >
                          ...
                          <p
                              className={cn(
                                  "text-sm font-medium",
                                  isActive ? "text-purple-700 dark:text-purple-300" : "dark:text-gray-200",
                              )}
                          >
                            {option.label}
                          </p>
