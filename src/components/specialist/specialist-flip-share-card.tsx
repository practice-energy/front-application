...
import {IconTelegram} from "@/src/components/icons/icon-telegram";
import {IconWhatsapp} from "@/src/components/icons/icon-whatsapp";
...
export function SpecialistFlipShareCard({ specialist, copied, onCopyLink, onShare, onClick }: SpecialistFlipShareCardProps) {
  ...
  return (
      ...
      >
          <div
              className="h-9 w-full py-1.5 px-2 bg-white justify-between flex flex-row items-center"
              onClick={onClick}
          >
          ...
          <div
              className="bg-colors-custom-specialistCardBg bg-practice-pattern h-full flex flex-col"
              onClick={onClick}
          >
              {/* Specialist Preview */}
              <div className="items-start gap-3 mt-6 bg-white p-1.5 flex-shrink-0 flex flex-col h-[92px]">
              ...
              {specialist.education.length > 0 ? (
                  <div className="flex flex-row p-1 bg-white py-1.5 px-2">
                      ...
                      <div className="aspect-square flex-shrink-0 bg-colors-neutral-150 rounded-sm ">
                  ...
                  <div className="flex flex-row bg-white py-1.5 px-2">
                      <div className="flex-1 min-w-0 pr-3">
                      ...
                      <div className="aspect-square flex-shrink-0 bg-colors-neutral-150 rounded-sm border">
