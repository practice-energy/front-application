    ...
    <div className="space-y-6">
        <div className="text-center space-y-3">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto transition-colors duration-300">
                We've pre-loaded your existing education from your profile. You can add additional experience below.
            </p>
        </div>

      <ExperienceForm
        title={t("specialist.professionalExperience")}
        description={t("specialist.experienceDesc")}
        items={experience}
