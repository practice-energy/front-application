...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-white dark:bg-gray-800 hover:bg-violet-50 dark:hover:bg-violet-700 active:bg-colors-custom-accent dark:active:bg-colors-custom-accent active:hover:bg-violet-700 dark:hover:active:bg-colors-custom-accent text-gray-900 dark:text-white active:text-white dark:active:text-white active:border-colors-custom-accent dark:active:border-colors-custom-accent px-3 py-2 h-9 font-medium transition-colors duration-200 flex items-center gap-1 group border border-gray-200 dark:border-gray-700",
        destructive:
        ...
        icon: "bg-transparent hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent dark:hover:text-accent-foreground",
      },
      size: {
