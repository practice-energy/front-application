...
import {ArrowLeft, ChevronLeft, Clock, Share} from "lucide-react"
...
export default function ServicePage({ params }: { params: { id: string } }) {
  ...
  const handleSearch = (query: string, category?: string) => {
    ...
    const searchParams = new URLSearchParams({
      ...
      serviceImage: URL.createObjectURL(service.images[0]) || "",
        ...
        <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-sm shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{service.name}</h1>
                ...
                <div className="space-y-6">
                  ...
                  <FeedbackSection feedbacks={service.feedbacks} title="Client Feedback" />
          ...
          <div ref={searchRef} className="fixed bottom-0 left-0 right-0 py-4">
            <div className="max-w-2xl mx-auto px-4 sm:px-6">
              <SearchBar onSearch={handleSearch} showHeading={false} dynamicWidth={true} placeholder="Забронировать услугу"/>
            </div>
          </div>
        </main>
