...
import {useAdeptChats, useBecomeSpecialist, useMasterChats} from "@/src/stores/chat-store"
import { IconPractice } from "@/src/components/icons/icon-practice";
import { MainMobileHeader } from "@/src/components/header/components/main-mobile-header";
import { useProfileStore } from "@/src/stores/profile-store";
import { useSidebar } from "@/contexts/sidebar-context";
import { useAuth } from "@/src/hooks/use-auth";
import { useIsMobile } from "@/src/hooks/use-mobile";
import { cn } from "@/src/lib/utils";
import { AuthButtons } from "@/src/components/auth-buttons";
import { initiationMessageValid, initiationMessageInvalid } from "@/src/components/become-specialist/messages";
