...
import { becomeSpecialistTags } from "@/src/services/become-specialist-tree-tag"
...
export const step4ContinueMessage = {
  ...
  isAI: true,
  content:
    "Ваш профиль создан и каждая из частей мира Пактис - доступна к изучению.\n\nУкажите слот, если хотите забронировать онлайн-демонстрацию возможностей взаимодействия:",
  timestamp: Date.now(),
  aiMessageType: "info" as const,
  footerContent: "Свободно переходите к самостоятельному изучению мира Практис: вы сможете забронировать слот онлайн-демонстрации в этом чате и на панели управления Мастера.\n\nПусть ваш путь наполнится возможностями вместо пустой части рутины.",
  bookingFrame: true,
